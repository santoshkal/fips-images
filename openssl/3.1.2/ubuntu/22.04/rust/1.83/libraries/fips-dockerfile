# ==============================================================================
# FIPS Rust Runtime - Libraries Only (NO TOOLCHAIN) - Ubuntu 22.04
# ==============================================================================
...
# ==============================================================================
FROM ubuntu:22.04 AS rust-libs-extractor
...
echo "CVE Count: Variable (Ubuntu updates)"
EOFSCRIPT
...
LABEL org.opencontainers.image.title="FIPS Rust Runtime (Ubuntu)" \
      org.opencontainers.image.description="FIPS 140-3 runtime with Rust libraries on Ubuntu 22.04" \
