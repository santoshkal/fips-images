...
ARG PATCH_INCLUDE="fips_3.12.patch"
...
# ------------------------------------------------------------------------------
# Build Python 3.12.9 with FIPS-enabled OpenSSL
# ------------------------------------------------------------------------------
...
RUN echo "==> Installing Python packages with FIPS support..." \
    ...
    # Install ensurepip
    && /opt/python-fips/bin/python3.12 -m ensurepip \
    # Upgrade pip and setuptools
    && /opt/python-fips/bin/python3.12 -m pip install --no-cache-dir \
    ...
    && CRYPTOGRAPHY_DONT_BUILD_RUST=1 \
       ...
       /opt/python-fips/bin/python3.12 -m pip install --no-cache-dir cryptography
...
RUN echo "==> Optimizing Python installation..." \
    ...
    && ln -sf /opt/python-fips/bin/python3.12 /opt/python-fips/bin/python3 \
    && ln -sf /opt/python-fips/bin/python3.12 /opt/python-fips/bin/python \
    && ln -sf /opt/python-fips/bin/pip3.12 /opt/python-fips/bin/pip3 \
    && ln -sf /opt/python-fips/bin/pip3.12 /opt/python-fips/bin/pip \
    ...
    && strip --strip-unneeded /opt/python-fips/bin/python3.12 2>/dev/null || true \
...
RUN ln -sf /usr/local/ssl/bin/openssl /usr/bin/openssl \
    ...
    && ln -sf /opt/python-fips/bin/python3.12 /usr/bin/python3 \
    && ln -sf /opt/python-fips/bin/python3.12 /usr/local/bin/python3 \
    && ln -sf /opt/python-fips/bin/python3.12 /usr/bin/python \
    && ln -sf /opt/python-fips/bin/python3.12 /usr/local/bin/python \
