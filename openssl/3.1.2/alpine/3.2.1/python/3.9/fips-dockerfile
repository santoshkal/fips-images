...
# ------------------------------------------------------------------------------
# Build Python 3.9.19 with FIPS-enabled OpenSSL
# ------------------------------------------------------------------------------
...
RUN echo "==> Installing Python packages with FIPS support..." \
    ...
    && /opt/python-fips/bin/python3.9 -m pip install --no-cache-dir \
...
RUN echo "==> Optimizing Python installation..." \
    ...
    && ln -sf /opt/python-fips/bin/python3.9 /opt/python-fips/bin/python3 \
    && ln -sf /opt/python-fips/bin/python3.9 /opt/python-fips/bin/python \
    && ln -sf /opt/python-fips/bin/pip3.9 /opt/python-fips/bin/pip3 \
    ...
    && strip --strip-unneeded /opt/python-fips/bin/python3.9 2>/dev/null || true \
...
RUN ln -sf /usr/local/ssl/bin/openssl /usr/bin/openssl \
    ...
    && ln -sf /opt/python-fips/bin/python3.9 /usr/local/bin/python3 \
    && ln -sf /opt/python-fips/bin/python3.9 /usr/bin/python \
    && ln -sf /opt/python-fips/bin/python3.9 /usr/local/bin/python \
